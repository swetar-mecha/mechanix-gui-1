...
use crate::{
    events::NmEvents, get_wireless_strength_icon, prelude::*, ui::{icon::{Icon, IconName}}
};
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .relative()
                    .overflow_hidden()   
                    .bg(rgb(DARK_NEUTRAL_900))  // Ensure background covers
                    ...
                    .child(
                        // Scrolling content - absolute positioned within clipping container
                        div()
                            .absolute()
