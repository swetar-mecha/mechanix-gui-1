...
enum DeviceInformationMessage {
    openModel(bool),
    ForgetDevice,
}

#[derive(Debug, Clone)]
pub struct DeviceInformationState {
    pub is_model_open: bool,
}

#[derive(Debug)]
#[component(State = "DeviceInformationState")]
...
impl DeviceInformation {
    pub fn new() -> Self {
        DeviceInformation {
            dirty: false,
            state: Some(DeviceInformationState {
                is_model_open: false,
            }),
        }
    }
...
#[state_component_impl(DeviceInformationState)]
impl Component for DeviceInformation {
    fn init(&mut self) {
    ...
    fn view(&self) -> Option<Node> {
        ...
        let mut bluetooth_status = "Connected";
        ...
        // } else {
        //     bluetooth_status = "Not Connected";
        ...
        .push(single_detail_row(DetailRow {
            ...
            value: bluetooth_status.to_string(),
        }))
        .push(node!(
            HDivider {
                size: 0.8,
            ...
            .push(
                ...
                .push(node!(
                    Button::new(txt!("Cancel"))
                        ...
                        .on_click(Box::new(move || msg!(DeviceInformationMessage::openModel(
                            !is_model_open
                        )))),
                    lay![
                        size_pct: [48, 100],
    ...
    fn update(&mut self, msg: mctk_core::component::Message) -> Vec<mctk_core::component::Message> {
        if let Some(message) = msg.downcast_ref::<DeviceInformationMessage>() {
            match message {
                DeviceInformationMessage::openModel(value) => {
                    self.state_mut().is_model_open = *value;
                }
                DeviceInformationMessage::ForgetDevice => {
