use crate::constants::{
    ...
    HOME_DIR_CONFIG_PATH, INFO_ICON, LANGUAGE_ICON, LOCK_ICON, REFRESH_ICON,
    SECURED_WIRELESS_ERROR, SECURED_WIRELESS_LOW, SECURED_WIRELESS_OFF, SECURED_WIRELESS_ON,
    SECURED_WIRELESS_STRONG, SECURED_WIRELESS_WEAK, SOUND_ICON, UPDATE_ICON, USR_SHARE_PATH,
    WHITE_RIGHT_ARROW, WIRELESS_ERROR, WIRELESS_GOOD, WIRELESS_LOW, WIRELESS_NOT_FOUND,
    WIRELESS_OFF, WIRELESS_ON, WIRELESS_SETTIGNS, WIRELESS_STRONG, WIRELESS_WEAK,
};
...
pub struct SeeOptions {
    pub white_right_arrow: String,
    pub grey_right_arrow: String,
...
impl Default for SeeOptions {
    fn default() -> Self {
        SeeOptions {
            white_right_arrow: WHITE_RIGHT_ARROW.to_owned(),
            grey_right_arrow: GREY_RIGHT_ARROW.to_owned(),
